//
//  Systematic_Sampling__Count_Based.cpp
//  Projeto
//
...
Systematic_Sampling__Count_Based::Systematic_Sampling__Count_Based(const string input_file,const string output_file, const bool d, const int sample_size) : Sniffer(input_file, output_file, d), _interval(4), _sample_size(sample_size){
    puts("Systematic_Sampling - default constructor");
    _sample_size = 1;
    Sniffer::start();
}

Systematic_Sampling__Count_Based::Systematic_Sampling__Count_Based(const string input_file, const string output_file, const bool d, const int interval, const int sample_size) : Sniffer(input_file, output_file, d), _interval(interval), _sample_size(sample_size) {
